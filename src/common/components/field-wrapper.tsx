...
export interface FieldWrapperProperties<T, TKey extends keyof T = keyof T> {
    ...
    index?: number
    children:
        | Array<React.ReactElement<Field<T[TKey]> | FieldWrapper<T[TKey]>>>
        | React.ReactElement<Field<T[TKey]> | FieldWrapper<T[TKey]>>
}
...
> extends React.Component<FieldWrapperProperties<T, TKey>> {
        ...
        return (
            <FieldWrapperContext.Consumer>
                {(value) => {
                    ...
                    return (
                        <FieldWrapperContext.Provider value={parentName}>
                            {this.props.children}
