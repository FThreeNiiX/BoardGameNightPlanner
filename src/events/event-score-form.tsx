...
export const EventScoreForm: React.FC<EventScoreFormProperties> = (props) => {
    ...
    const list = JSON.parse(
        JSON.stringify(props.attendees)
    ) as AttendeeWithScore[]
    list.forEach((a) => (a.score = a.score || 0))

    return (
        <Formik<AttendeesList>
    ...
    async function handleSubmit(
        values: AttendeesList,
        formikHelpers: FormikHelpers<AttendeesList>
    ) {
        const scores: Scores = {}
...
EventScoreForm.whyDidYouRender = false
